...
$(document).ready(function() {
	/*
	 * $(".btn-pref .btn").click(function() { $(".btn-pref
	 * .btn").removeClass("btn-primary").addClass("btn-default");
	 * $(this).removeClass("btn-default").addClass("btn-primary"); });
	 */

	// This is called with the results from from
	// FB.getLoginStatus().
	...
	window.fbAsyncInit = function() {
		...
		// the
		// person visiting this page and can return one of three
		// states to
		// the callback you provide. They can be:
		//
		// 1. Logged into your app ('connected')
		// 2. Logged into Facebook, but not your app
		// ('not_authorized')
		// 3. Not logged into Facebook and can't tell if they
		// are logged into
		// your app or not.
		//
		// These three cases are handled in the callback
		// function.
	...
	// login is
	// successful. See statusChangeCallback() for when this call
	// is made.
